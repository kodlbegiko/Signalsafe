# SignalSafe Research Participation Notice v1

Consent version: `signalsafe-consent-2026-08-10-v1`

Status: website research-participation information for SignalSafe v0.3.1. This notice records the same substantive sections shown in Research Mode. It is **not** a claim that IRB, school approval, guardian consent, or any other required external procedure has been completed.
...
1. 我已閱讀並理解這項研究的目的與測試流程。
2. 我了解系統會記錄匿名研究資料、作答內容與研究流程資料。
3. 我了解參與是自願的，並且可以暫停或停止參與。
4. 我確認研究者已向我完成本次研究所需的說明；如果另有書面、監護人、學校或其他正式同意程序，這些程序應由研究團隊依規定另外完成。

Final explicit choice: `我願意參與 SignalSafe 本次研究測試` or `暫不參與`.
